...
public class ActivityGoogleUser extends AppCompatActivity {
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Picasso.with(ActivityGoogleUser.this).load(user.getPhotoUrl()).into(imgProfile);
                    ...
                    Intent intent = new Intent(ActivityGoogleUser.this, ActivityGoogleLogin.class);
